...
_ENV_KEYS_TO_CLEAN = [
    ...
    "AUTOSRE_DB_PATH",
    "AUTOSRE_PORT",
    "AUTOSRE_BACKEND_MODE",
    "AUTOSRE_HTTP_AUTHORIZATION",
    "AUTOSRE_HTTP_HEADERS_JSON",
    "AUTOSRE_WEBHOOK_TOKEN",
    "PROMETHEUS_QUERY_TEMPLATE",
    "ELK_INDEX",
    "AWX_JOB_TEMPLATE_MAP_JSON",
    "AUTOSRE_PLAYBOOK_ALLOWLIST",
    "AUTOSRE_MAX_REMEDIATION_HOSTS",
    "AUTOSRE_FORBIDDEN_HOST_SUBSTRINGS",
    "AUTOSRE_AUDIT_LOG",
    "AUTOSRE_WEBHOOK_RATE_LIMIT_PER_MINUTE",
    "AUTOSRE_REQUIRE_WEBHOOK_TOKEN",
    "AUTOSRE_WEBHOOK_TOKEN",
]
